...
// function change(){
    ...
    echo color("green","                  Format Kode 62*** \n");
        ...
        echo color("grey","+] Your access token : ".$token."\n\n");
        save("token.txt",$token);
        echo color("red","\n===========(REDEEM VOUCHER)===========");
        echo "\n".color("yellow","▶️ Ambil Vc 20+10 ");
        echo color("yellow","▶️ Tunggu sebentar");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(25);
        }
...
sleep(1);
        ...
        echo "\n".color("nevy","▶️ Total voucher ".$total." : ");
        ...
        setpin:
         ...
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("nevy","!] Coba input lagi\n");
         goto otp;
         }
         }else{
         echo color("red","-] Nomor udah terdaftar.");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("nevy","!] Coba Nomer Fresh Lainnya \n");
         goto ulang;
         }
//  }
